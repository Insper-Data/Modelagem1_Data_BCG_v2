...
class Pipeline:
    ...
    def __init__(self, user: str, key_name: str, coluna_para_transformar_X: str, coluna_para_transformar_y,
                 versao: str, tipo: str, granularidade=False, transformacao_X=False, transformacao_y = False,
        ...
        self.variaveis_X = Variaveis(self.user, date.today(), self.key_name, self.coluna_para_transformar_X, self.versao,
                                     'X', self.tipo, self.granularidade, self.transformacao_X, self.nome_do_arquivo)

        self.variaveis_y = Variaveis(self.user, date.today(), self.key_name, self.coluna_para_transformar_y, self.versao,
